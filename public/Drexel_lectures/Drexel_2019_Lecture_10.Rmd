...
- Estimate of $\sigma$: it is well known that $$\frac{RSS}{n-2}$$ is an _unbiased_ estimator of $\sigma$, where $n$ is the sample size.
...
Alternatively, one can use output from `summary(fit)`:
