...
equals $1-\alpha$. Here $t_{n-1,\alpha/2}$ is determined so that $P(T\leq t_{n-1,\alpha/2})=1-\alpha/2$, where $T$ follows a $t$-distribution with $n-1$ degrees of freedom. 
...
Download a tab-delimited file [crabs.tsv](crabs.tsv) (Chrome users: Menu $\rightarrow$ More Tools $\rightarrow$ Save Page As). It consists of 173 observations and 5 variables. 
