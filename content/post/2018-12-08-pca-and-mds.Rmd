...
Our goal is to find a _good_ (meaning to be clarified later) two dimensional projection $\mathbf{Q}_1, \cdots, \mathbf{Q}_{`r n`}$ of $\mathbf{P}_1, \cdots, \mathbf{P}_{`r n`}$ so that we can reduce the dimension (from 3 to 2) of data and and visualize them. 

If $x$, $y$, and $z$ variables should be equally weighted, then the data points should be centered and normalized:
